...
*/
//!!!!!!!!!!!!!!!!!!!!
#pragma comment (lib,"glut32.lib") // 링크 
#pragma comment (lib,"glaux.lib") // 임의의 상대경로 입력한다.
#include<GL/GLAux.h>
#include<GL/glut.h>
#include<cstdio>
//#include<cmath>
...
unsigned grassTextureId = -1;
AUX_RGBImageRec *rec_texture = NULL;
AUX_RGBImageRec *grass_texture = NULL;

GLUquadricObj *c = NULL; // Cylinder
...
void drawRectangle(GLfloat r, GLfloat g, GLfloat b, unsigned texture = textureId);
void drawBase(int mode = 1);
void drawLower(int mode = 1);
void drawUpper(int mode = 1);
void drawCameraBot();
void drawBackGround(unsigned texture = grassTextureId);
void drawFigure();
...
int main(int argc, char** argv){
	...
	//glutCreateWindow("2011122355_light_shade1");
	...
	rec_texture = auxDIBImageLoad(L"1.bmp");
	glGenTextures (1,&textureId);
    glBindTexture (GL_TEXTURE_2D,textureId);
    glPixelStorei (GL_UNPACK_ALIGNMENT,1);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_S,GL_REPEAT);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_T,GL_REPEAT);
    gluBuild2DMipmaps( GL_TEXTURE_2D, GL_RGB, rec_texture->sizeX, rec_texture->sizeY, GL_RGB, GL_UNSIGNED_BYTE, rec_texture->data);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	//glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR_MIPMAP_LINEAR);    
	//glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);

	grass_texture = auxDIBImageLoad(L"grass.bmp");
	glGenTextures (1,&grassTextureId);
    glBindTexture (GL_TEXTURE_2D,grassTextureId);
    glPixelStorei (GL_UNPACK_ALIGNMENT,1);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_S,GL_REPEAT);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_WRAP_T,GL_REPEAT);
    gluBuild2DMipmaps( GL_TEXTURE_2D, GL_RGB, grass_texture->sizeX, grass_texture->sizeY, GL_RGB, GL_UNSIGNED_BYTE, grass_texture->data);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
...
* 배경을 그리는 Function
*/
void drawBackGround(unsigned texture){
...
*/
float recPoint;
void drawRectangle(GLfloat r, GLfloat g, GLfloat b , unsigned texture){
